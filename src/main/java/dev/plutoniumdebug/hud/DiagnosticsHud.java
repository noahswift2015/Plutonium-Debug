...
public final class DiagnosticsHud extends HudElement {
    ...
    public static final HudElementInfo<DiagnosticsHud> INFO = new HudElementInfo<>(
        GROUP,
        "diagnostics",
        "Shows safe loaded-world diagnostic status.",
        DiagnosticsHud::new
    );
    ...
    public void render(HudRenderer renderer) {
        ...
        setSize(
            Math.max(renderer.textWidth(title), renderer.textWidth(status)),
            renderer.textHeight() * 2
        );
